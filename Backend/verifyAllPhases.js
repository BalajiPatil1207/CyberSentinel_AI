...
import { aiChat, getChatHistory, malwareAnalyze, getVulnerabilities, patchVulnerability } from "./controllers/securityController.js";
...
async function runTests() {
  ...
  try {
    ...
    // ----------------------------------------------------
    // TEST 3: AI Security Copilot Chat and History
    // ----------------------------------------------------
    ...
    console.log("  AI Copilot Reply:", res3.body.data.reply);
    ...
    // ----------------------------------------------------
    // TEST 4: Malware Sandbox Analyzer
    // ----------------------------------------------------
    ...
    // ----------------------------------------------------
    // TEST 5: Vulnerability List and Patching
    // ----------------------------------------------------
    console.log("\n[TEST 5] Fetching and Patching System Vulnerabilities...");
    ...
    if (listRes.body.data.length !== 1) {
      throw new Error("Test 5 Failed: Could not fetch vulnerability list.");
    }
    ...
    if (patchRes.body.data.status !== "Resolved") {
      throw new Error("Test 5 Failed: Status did not update to Resolved.");
    }
